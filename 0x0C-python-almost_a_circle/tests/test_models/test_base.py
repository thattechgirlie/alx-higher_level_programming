...
Unittest Classes:
    ...
    Test_Base_load_from_file - line 338
    Test_Base_save_to_file_csv - line 404
    Test_Base_load_from_file_csv - line 482
"""
import os
import unittest
...
class TestBase_save_to_file(unittest.TestCase):
    """Unittest to test save_to_file of Base class."""
    ...
    def test_to_save_file_one_rectangle(self):
...
class TestBase_from_json_string(unittest.TestCase):
    """Unittest testing from_json_string method of Base Class."""


    def test_from_json_string_type(self):
        list_input = [{"id": 89, "width": 10, "height": 4}]
        json_list_input = Rectangle.to_json_string(list_input)
        list_output = Rectangle.to_json_string(json_list_input)
...
class TestBase_load_from_file(unittest.TestCase):
    """Unittests for load_from_file_method of class Base."""
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """Unittesting save_to_file_csv method of class Base."""
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """Unittest for testing load_from_file_csv of class Base."""
