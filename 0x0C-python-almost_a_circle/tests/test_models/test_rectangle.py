...
class Rectangle_instantiation(unittest.TestCase):
...
class TestRectangle_width(unittest.TestCase):
    """Unittest to test initialization of Rectangle width attribute."""
...
class TestRectangle_height(unittest.TestCase):
    """Unittest for testing initialization of Rectangle height attr."""
...
class TestRectangle_x(unittest.TestCase):
    """Unittest to test initialization of Rectangle x attribute."""
    ...
    def test_bytearray_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(1, 2, bytearray('abcdefg'))
...
class Rectangle_y(unittest.TestCase):
    """Unittest to test initialization of Rectangle y attribute."""
...
class TestRectanglr_order_of_initialization(unittest.TestCase):
    """Unittest for testing Rectangle attribute initialization."""
...
class Rectangle_area(unittest.TestCase):
    """Unittest for testing area method of class Rectangle."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittest to test __str__ and display method of class Rectangle."""
...
class TestRectangle_update_args(unittest.TestCase):
    """Unittest for testing update args method of class Rectangle."""
    ...
    def test_update_args_invalid_width_negative(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(89, -5)
    ...
    def test_update_args_invalid_height_zero(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            r.update(89, 1, 0)

    def test_update_args_invalid_height_negative(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            r.update(89, 1, -5)
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittest to test update kwargs of class Rectangle."""
    ...
    def test_update_kwargs_invalid_height_zero(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "height must be > 0"):
            r.update(height=0)

    def test_update_kwargs_invalid_height_negative(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "height must be > 0"):
            r.update(height=-5)
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Unittests for testing to_dictionary method of class Rectangle."""
